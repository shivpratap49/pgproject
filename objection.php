...
echo"Error";
  ...
  ?>
    <div id="cont" class="flex-column">
        ...
        <div class=" justify-content-center mb-auto  w-75 align-item-start" id="preapp"
            style="display:flex">
            <div class="w-100 p-3 border boreder-1 shadow-lg p-3 mb-5 bg-body rounded rounded-4">
