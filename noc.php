            ...
            <form action="noc.php" method="post" onsubmit="return valid()" name="form">
                <div class="container-sm border border-dark mt-5 ">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-5">
                            <input type="text" name="exam_name" class="form-control" id="formGroupExampleInput" placeholder="i.e. Assistant Section Officer Examination 2022 ">
                    ...
                    <div class="row p-2">
                        <div class="col-4">
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="i.e. Assistant Section Officer Examination 2022">
                        ...
                        <div class="col-4">
                            <input type="text" name="advt_no" class="form-control" id="formGroupExampleInput" placeholder=" i.e. Advt. NO 26 of 2021-2022 ">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-3">
                            <input type="text" name="board" class="form-control" id="formGroupExampleInput" placeholder="OPSC/OSSC/OSSSC. ">
                    ...
                    <div class="row p-2 ">
                        ...
                        <div class="col-4">
                            <p class="mb-0"> <img src="<?php echo $row['signature_path'] ?>" alt="avatar" class="border border-dark  img-fluid border border rounded" style="width: 120px; height: 50px;"> </p>
                        </div>
                    </div>
