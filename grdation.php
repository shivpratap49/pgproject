...
<table class="table table-striped mb-5" style="font-size: 14px;">
    ...
    <table class="table table-striped">
      ...
      ?>
                                                <table class="table table-striped" style="font-size: 14px;">
                                                    <tr>
                                                        <th colspan="15" class="text-center fs-2 "> Assistant Revenue
      ...
      ?>
                                                            <table class="table table-striped" style="font-size: 14px;">
                                                                <tr>
                                                                    <th colspan="15" class="text-center fs-2 "> Revenue
                                                                        Inspector Gradation list</th>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="col">SL NO.</th>
                                                                    ...
                                                                    <th scope="col">Date of Entry into Govt. Service
                                                                    </th>
                                                                    <th scope="col">POST NAME (intial grade)</th>
                                                                    <th scope="col">JOI. DATE (present grade)</th>
                                                                    <th scope="col">THEORY</th>
              ...
              ?>
                                                                        <table class="table table-striped"
                                                                            ...
                                                                            <tr>
                                                                                <th colspan="15"
                                                                                    class="text-center fs-2 "> Revenue
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th scope="col">Date of Entry into
                                                                                    Govt. Service</th>

                                                                                <th scope="col">POST NAME (intial
                                                                                    grade)</th>
                                                                                <th scope="col">JOI. DATE (present
                                                                                    grade)</th>
                                                                                <th scope="col">THEORY</th>
                                                                                <th scope="col">PRACTICAL</th>
                                                                                <th scope="col">DEPRTMENT EXAM </th>
    ...
    ?>
                                                                                    <table class="table table-striped"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <th scope="col">PA_MONTH
                                                                                            </th>
                                                                                            <th scope="col">PA_YEAR
                                                                                            </th>
                                                                                            <th scope="col">FA_MONTH
                                                                                            </th>
                                                                                            <th scope="col">FA_YEAR
                                                                                            </th>
                                                                                            <th scope="col">
                                                                                                J_SC_DATE</th>
                                                                                            <th scope="col">
